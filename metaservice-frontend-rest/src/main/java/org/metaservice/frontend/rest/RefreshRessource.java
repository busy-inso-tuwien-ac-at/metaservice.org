...
@Singleton
@Path("/refresh")
public class RefreshRessource {

    private static final Logger LOGGER = LoggerFactory.getLogger(RefreshRessource.class);

    public RefreshRessource() throws JMSException {
