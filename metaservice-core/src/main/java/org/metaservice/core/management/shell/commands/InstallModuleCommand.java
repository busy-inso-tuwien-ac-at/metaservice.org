...
import org.metaservice.core.management.shell.commands.AbstractManagerCommand;
import org.metaservice.core.management.shell.completer.ModuleCompleter;
...
public class InstallModuleCommand extends AbstractManagerCommand {
    ...
    @Arguments(completer = ModuleCompleter.class, validator = ModuleValidator.class)
