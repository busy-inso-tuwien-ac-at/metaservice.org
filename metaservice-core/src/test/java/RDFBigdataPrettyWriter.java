 ...
 */
public class RDFBigdataPrettyWriter extends RDFXMLWriter implements Closeable, Flushable {
     ...
     */
    public RDFBigdataPrettyWriter(OutputStream out) {
        super(out);
    }
     ...
     */
    public RDFBigdataPrettyWriter(Writer out) {
        super(out);
    }
            ...
            throws IOException
    {
        ...
        setNamespace("bigdata","http://www.bigdata.com/rdf#");
            ...
            throws IOException, RDFHandlerException
    {
        ...
        if (predicateStack.isEmpty()) {
            ...
            if (!topNode.hasType()) {
                ...
                writeAbbreviatedPredicate(topPredicate, topNode.getValue(),topNode.sid);
            }
            else {
                ...
                if(topNode.getSid() != null)
                    writeAttribute("http://www.bigdata.com/rdf#","sid",topNode.getSid().stringValue());
            ...
            throws RDFHandlerException
    {
        ...
        if(context != null && !(context instanceof BNode))
            throw new RuntimeException("Only Bnodes are allowed as SID");
        BNode sid = (BNode) context;
        ...
        try {
            ...
            if (nodeStack.isEmpty()) {
                // Push subject
                nodeStack.push(new Node(subj, sid));
            }
            ...
            if (pred.equals(RDF.TYPE) && obj instanceof URI && !topSubject.hasType() && !topSubject.isWritten())
            {
                ...
                nodeStack.push(new Node(obj, sid));
            }
        }
        catch (IOException e) {
     ...
     */
    private void writeAbbreviatedPredicate(URI pred, Value obj,BNode sid)
            throws IOException, RDFHandlerException
    {
        ...
        if (obj instanceof Resource) {
            ...
            if(sid != null)
                writeAttribute("http://www.bigdata.com/rdf#","sid",sid.getID());
    ...
    private static class Node {
         ...
         */
        public Node(Value value,BNode sid) {
            this.value = value;
            this.sid = sid;
        }
